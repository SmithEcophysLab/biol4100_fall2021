...
(2) Attend the 1-hour lab meeting each week if your course schedule allows\par
(3) Attend the 1-hour small group meeting each week (time TBD)\par
(4) Maintain an electronic journal\par
(5) Adhere to the safety instructions at all times\par
...
in a subsequent semester. In some cases, a research manuscript may be substituted 
for the project proposal if the student carries out an independent research project.
